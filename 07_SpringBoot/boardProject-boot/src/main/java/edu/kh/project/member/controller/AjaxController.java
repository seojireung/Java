...
public class AjaxController {
	...
	public String selectMemberTel(String nickname) {
		...
		// @ResponseBody
		// -> Controller의 결과로 데이터를 반환(응답)할 때 사용하는 어노테이션
		
		return service.selectMemberTel(nickname);
		// 비동기 요청한 VSC main.js으로 반환
		
	}
	
	// 이메일 중복 검사
	// (참고)produces 속성은 한글 깨질 때 사용!!
	...
	public Member selectMember(@RequestBody Map<String, Object> paramMap) {
		...
		String email = (String)paramMap.get("email"); // JSON의 key 값
					  // 다운캐스팅
     ...
     *           Java객체로 변환(HttpMessageConverter가 알아서 해줌)
     * 
     * - 응답 방법(GET/POST 구분 X)
