...
-- 13번
SELECT DEPARTMENT_NO 학과코드명, COUNT(DECODE(ABSENCE_YN,'Y','')) "휴학생 수"
FROM TB_STUDENT
GROUP BY DEPARTMENT_NO
ORDER BY 학과코드명 ; 

-- COUNT 0 세려고 null 값 넣기 위한 DECODE 인용
--SELECT DEPARTMENT_NO,DECODE(ABSENCE_YN,'Y','Y')
--FROM TB_STUDENT
--ORDER BY DEPARTMENT_NO ;

-- NVL 시도
--SELECT DEPARTMENT_NO 학과코드명, COUNT(NVL(ABSENCE_YN,'1')) "휴학생 수"
--FROM TB_STUDENT
--WHERE ABSENCE_YN = 'Y'
--GROUP BY DEPARTMENT_NO
--ORDER BY 학과코드명 ;
