...
-- 입사일이 빠른 순으로 조회하시오
-- 단, 퇴사한 직원은 제외하고 조회..
SELECT EMP_ID, EMP_NAME, NVL(DEPT_TITLE, '소속없음'), JOB_NAME, TO_CHAR(HIRE_DATE,'YY/MM/DD') HIRE_DATE, DEPT_CODE
FROM EMPLOYEE MAIN
...
SELECT EMP_ID, EMP_NAME, JOB_NAME,
	...
	TO_CHAR(SALARY*(NVL(BONUS,0)+1)*12, 'L999,999,999') "보너스 포함 연봉"
FROM EMPLOYEE MAIN
