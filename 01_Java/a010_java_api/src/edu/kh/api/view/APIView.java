...
public class APIView {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("5. String Buffe / Builder");
	...
	private void ex1() {
		...
		sc.nextLine(); // 입력 버퍼에 남아 있는 개행문자 제거
	...
	private void ex2() {
		...
		// 입력한 문자열을 바로 service의 selecName으로 보냄
	...
	private void ex4() {
		...
		String s2 = "abc"; // String은 사용 빈도가 높기 때무에
...
//		StringBuffer sb = new StringBuffer();
		...
		// - StringBuffer에 저장된 문자열(필드값)을 String 형태로 반환
		...
		// delete(int start, int end) : 삭제(start이상 end미만 삭제)
	...
	private void ex6() {
		...
		while(true) {
			// sc.nextLine() : 한 줄을 입력 받아 String으로 반환 (엔터까지 입력 받지만 출력 시 써먹진 않음)
