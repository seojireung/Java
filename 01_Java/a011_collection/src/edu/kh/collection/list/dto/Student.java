...
public class Student implements Comparable<Student>{
	...
	@Override
	public int compareTo(Student other) { // 현재 나랑 다른 애(비교 대상자가 됨)
...
//		return this.score - other.score; // 결과가 양수면 자리 바뀜(오름차순)
		
		return other.score - this.score; // 결과가 양수면 자리 바뀜(내림차순)
