...
public class ArrayEx1 {
	 ...
	 * 
	 * - 묶여진 변수들은 하나의 이름(배열명)으로 불러지고 각각의 변수는 index를 이용해서 구분함
	 * 
	 * - index는 0부터 시작
	 * 
	 */
	...
	public void ex2() {
		...
		System.out.println(numbers); // [I@5eb5c224 (주소로 만든 숫자)
										// -> 지금은 주소로 봐도 무관
	...
	public void ex3() {
		...
		for (int i = 0; i < heightArray.length; i++) {
			// 3
			System.out.printf("%d번의 키 입력 : ", i + 1);
