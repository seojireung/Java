...
// -> 비즈니스 로직 작성 (로직 : 결과 하나를 내기 위한 모든 과정)
public class MethodExService {
	...
	public String calculate(int num1, int num2, String op) {
		   //문자열 반환   // 매개 변수명을 일치 시켜 이해도 향상
		 				  // (단, 클래스가 다르기 때문에 변수 명이 같다고 해서 같은 변수x (동명이인))
		...
		// boolean a.equals(b)
		// -> a와 b가 참조하는 객체의
		//    값이 같다면 true, d아니면 false를 반환하는 메서드
