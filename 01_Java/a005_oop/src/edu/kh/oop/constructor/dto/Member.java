...
public class Member {
	...
	// 생성자 작성 규칙
	// 1. 반환형 (void, int, String...) 이 없다 (메소드 선언과의 차이)
	// 2. 생성자명은 클래스와 동일!
	...
	public Member(String memberId, String memberPw) {} // 성립 (개수 다름)
	
	public Member(String memberId, int memberAge) {} // 성립 (자료형 다름)
	
	public Member(int memberAge, String memberId) {} // 성립 (순서 다름)
