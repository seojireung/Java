...
public class ExceptionService {
	...
	public void ex2() {
		...
		//  -> Exception이 발생할 경우를 대비해서 예외처리 구문 작성해라 (강제)
		...
		System.out.println("try-catch가 수행돼도 프로그램이 종료되지 않음");
	...
	public void ex3() {
		...
		// catch(Exception e) {} 
			...
			System.out.println("예외가 발생해서 처리 함.");
...
//			e.getMessage();
	...
	public void methodB() throws IOException {
		...
		methodC();
		// methodC는 IOException을 던질 수도 있기 때문에
...
//			throw new ScoreInputException(); // 기본 생성자
			throw new ScoreInputException("ex5() 호출 중 0~100 사이 범위 초과");
			                              // 어느 위치에서 어떤 오류가 발생했는지 간략하게 작성하면 좋음
		}
