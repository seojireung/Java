...
public class SwitchEx {
	...
	/*
	 * switch문 (switch - case문) - 식 하나의 결과로 많은 경우의 수를 처리할 때 사용하는 조건문 -> 식의 결과에 맞는
	 * case문이 수행됨
	 * 
	 * [작성법] Switch(식) { // 식 수행 결과는 true/false가 아닌 값(정수, 문자열 제일 많이 씀)
	 * 
	 * case 결과값1 : 수행코드1; break; // 들여쓰기 x case 결과값2 : 수행코드2; break; case 결과값3 :
...
//		}
	...
	public void ex3() {
		...
		case "떡볶이":
			...
			break;
		default:
			price = -1; // 잘못 입력한 경우에 사용하지 않는 숫자(-1)를 이용해서 표현
		}
	...
	public void ex4() {
		...
		case "/" : 
			if (num2 == 0) {
				...
				System.out.printf("%d %s %d = %.3f", num1, operator, num2, ((double)num1/num2));
			}; break;
		case "%" : System.out.printf("%d %s %d = %d", num1, operator, num2, (num1%num2)); break;
	...
	public void ex5() {
		...
		// break : 멈추다
		// -> 해당 case를 수행한 후 멈춰라!
		// -> break 미작성 시 다음 case가 연달아 수행된다! (식 값 무시)
