...
public class MainDAO {
	...
	private PreparedStatement pstmt; // placeholder를 포함한 SQL 세팅/수행 (Statement의 자식)
	private ResultSet rs; // SELECT 수행 결과 저장
	
	private Properties prop;
	// - Map<Strint,String> 형태
	// - XML 파일 입/출력 메서드를 제공
