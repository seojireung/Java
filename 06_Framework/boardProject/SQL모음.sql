...
FROM (
SELECT '웹접근 경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
	0 IMG_ORDER, 1508 BOARD_NO 
FROM DUAL
UNION ALL
SELECT '웹접근 경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
	1 IMG_ORDER, 1508 BOARD_NO 
FROM DUAL
UNION ALL
SELECT '웹접근 경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
	2 IMG_ORDER, 1508 BOARD_NO 
FROM DUAL
)A;
...
WHERE BOARD_NO = 1518 AND BOARD_CODE = 1;
...
-- 샘플 댓글 삽입
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT, DEFAULT, 1518, 1, NULL);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 1518, 1, NULL);

-- 1334 1335
-- 자식댓글
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 1518, 1, 1334);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 1518, 1, 1334);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 1518, 1, 1334);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 1518, 1, 1335);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 1518, 1, 1335);

-- 자식 2-1 : 1,338번
-- 자식의 자식 댓글
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식의 자식 댓글 2-1-1', DEFAULT, DEFAULT, 1518, 1, 1338);
