...
document.getElementById("btn1").addEventListener("click", () => {
    ...
    console.log(document.getElementById("test").fistChild);
...
document.getElementById("btn2").addEventListener("click", () => {
    ...
    // 2번째 요소 선택
    // test.firstElementChild.nextElementSibling.style.backgroundColor = "skyblue";
    list[1].style.backgroundColor = "skyblue";

    // btn2 누르고 해당 요소 클릭 시 alert 확인 가능
...
btn4.addEventListener('click', () => {
    ...
    // 3번, 2번 순서 바뀌어도 가능 (child의 내용까지 작성하고 화면 출력 형식)
